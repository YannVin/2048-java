...
public class Case {
    ...
    public void deplacer(Direction d) { //deplace une case ne fonction de la direction
        if (d == Direction.gauche) {
            ...
            if ((actu.y != 0) && (voisinC.getValeur() == actuC.getValeur())) { // on fusionne si meme case
        ...
        }else if(d == Direction.droite) // meme chose pour la droite
        {
            ...
            if ((actu.y != j.getSize()-1) && (voisinC.getValeur() == actuC.getValeur())) {
                voisinC.setValeur(actuC.getValeur()+voisinC.getValeur());
                actuC.setValeur(0);
            }
        }
        else if(d == Direction.haut) //meme chose pour haut
        {
            ...
            if ((actu.x != 0) && (voisinC.getValeur() == actuC.getValeur())) {
                voisinC.setValeur(actuC.getValeur()+voisinC.getValeur());
                actuC.setValeur(0);
            }
        }
        else if(d == Direction.bas)
        {
            ...
            if ((actu.x != j.getSize()-1) && (voisinC.getValeur() == actuC.getValeur())) {
                voisinC.setValeur(actuC.getValeur()+voisinC.getValeur());
                actuC.setValeur(0);
            }
        }
